package com.pibox.um.constant;

public class FileConstant {

    public static final String USER_IMAGE_PATH = "/user/image/";
    public static final String JPG_EXTENSION = "jpg";
    public static final String USER_FOLDER = System.getProperty("user.home") + "/um/user";
    ...
    public static final String TEMP_PROFILE_IMAGE_BASE_URL = "https://roboslash.org/";
}
